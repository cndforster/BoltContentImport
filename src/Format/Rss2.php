...
class Rss2 extends BaseFormat implements IFormat {
    ...
    public function parse($url){
        ...
        /*
        $xml = simplexml_load_string($input, 'SimpleXMLElement', LIBXML_NONET | LIBXML_NOCDATA );
        ...
        */
        ...
        unset($result["channel"]["item"]);

        return $result;
    }

    /**
     * Shamelsess copy from Tamlyn Rhodes
     * Could not find any simpler/cleaner xml to array converter that can work with namespaces
     *
